...
import { PageHero, Container, PrintButton, PrintHeader } from '../components/ui.jsx'
import DataTable from '../components/DataTable.jsx'

const ketBadge = (k) => {
  const map = { 'Dihuni': 'bg-emerald-500/15 text-emerald-300', 'Dikontrakkan': 'bg-amber-500/15 text-amber-300', 'Kosong': 'bg-white/10 text-zinc-400' }
...
export default function DataWarga() {
  ...
  return (
    <div>
      <PageHero kicker="Menu Warga" title="Data Kavling & Warga"
      ...
      <Container>
        ...
        <div className="mb-6 grid gap-4 sm:grid-cols-3">
          {[['Dihuni', dihuni, 'text-emerald-400'], ['Dikontrakkan', kontrak, 'text-amber-400'], ['Kosong', kosong, 'text-zinc-400']].map(([l, v, c]) => (
        ...
        <DataTable
          ...
          columns={[
            { key: 'no', label: 'No', align: 'center', render: (_r, idx) => idx + 1 },
