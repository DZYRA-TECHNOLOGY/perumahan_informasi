...
const KAT_FOTO = {
  'Rental Mobil': 'https://images.unsplash.com/photo-1502877338535-766e1452684a?w=800&q=80&auto=format&fit=crop',
  'Makanan': 'https://images.unsplash.com/photo-1504674900247-0877df9cc836?w=800&q=80&auto=format&fit=crop',
  ...
  'Kontrakan': 'https://images.unsplash.com/photo-1560448204-e02f11c3d0e2?w=800&q=80&auto=format&fit=crop',
}
const KAT_EMOJI = { 'Rental Mobil': '🚗', 'Makanan': '🍲', 'Jasa': '🧺', 'Toko': '🛒', 'Kontrakan': '🏠' }
const KAT_WARNA = {
  'Rental Mobil': 'from-sky-400 to-blue-600', 'Makanan': 'from-orange-400 to-rose-500',
  'Jasa': 'from-cyan-400 to-sky-600', 'Toko': 'from-amber-400 to-orange-600', 'Kontrakan': 'from-emerald-400 to-teal-600',
}
...
export function coverProps(item = {}) {
  return {
    ...
    warna: item.warna || KAT_WARNA[item.kategori] || 'from-orange-400 to-orange-600',
  }
}
  ...
  return (
    <div className="border-b border-white/10 bg-gradient-to-b from-orange-500/[0.08] to-transparent">
      <div className="mx-auto max-w-6xl px-4 py-12 sm:py-16">
        {kicker && <p className="text-sm font-semibold uppercase tracking-widest text-orange-500">{kicker}</p>}
...
export function PrintHeader({ title }) {
  return (
    <div className="print-title mb-4 border-b border-black pb-3">
      ...
      <p className="text-sm">Portal Transparansi Warga · Desa Sabah Balau, Jati Agung, Lampung Selatan</p>
    </div>
  )
}
