  ...
  return (
    <div>
          ...
          >
            ...
            <dl className="mt-4 space-y-2 text-sm">
              <div className="flex justify-between">
                ...
                <dd className="font-medium">{STATUS[selected.status].label}</dd>
              </div>
              <div className="flex justify-between">
                <dt className="muted">DP</dt>
                <dd className="font-medium">{rp(selected.dp)}</dd>
              </div>
              <div className="flex justify-between">
                <dt className="muted">Posisi Hook</dt>
                <dd className="font-medium">
                  {selected.hook ? "Ya (+Rp 10 jt)" : "Tidak"}
                </dd>
              </div>
            </dl>
            <button
      ...
      <p className="mt-4 text-xs muted">
        Klik kavling untuk detail. Titik kuning = posisi hook. Warna mengikuti
        legenda siteplan resmi.
      </p>
    </div>
  );
}
